...
Some technology stacks provide a *Resource Server Framework* that operates like a black box and requires very little code. This may work fine, but this blog uses a library approach to meet the above behaviours.
...
| <span style={{color:'green'}}>**Audience**</span> | The audience represents one or more related APIs, and the API must specify a value such as *api.authsamples-dev.com* |
...
We covered the key behaviour and design choices when validating JWTs in APIs, in a way that is easy for developers to learn. Next we will make some recommendations on getting started with your own authorization server.

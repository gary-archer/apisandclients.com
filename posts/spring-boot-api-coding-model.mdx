...
Our Node.js API used *Promises* to achieve this, with only a small impact on the overall coding model. In Java we will aim for an equivalent solution.

### Java Non Blocking API Solutions

There are a few approaches to using async await code in Java, summarized below. Each of these has very different behaviour:
...
| [Completable Futures](https://www.baeldung.com/java-completablefuture) | Non blocking I/O in line with Node.js and .NET, with a traditional coding model |

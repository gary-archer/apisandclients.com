...
The Mobile UI will provide the same <Link href='/posts/api-journey-client-side'>API Client Journey</Link> as for earlier Web UIs, with a simple list view as the home page:
...
Our iOS App will be coded entirely in [Swift and SwiftUI](https://developer.apple.com/videos/play/wwdc2020/10041), for the simplest syntax in areas such as navigation, data binding and async handling.

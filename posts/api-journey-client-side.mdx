...
| ----------- | ---------------- |
| <span style={{color:'green'}}>**SPA**</span> | https`:`//web.authsamples.com/spa/companies/2 |
| <span style={{color:'green'}}>**Desktop**</span> | x-mycompany-desktopapp`:`/companies/2 |
...
- A Desktop App developed in <Link href='/posts/final-desktop-sample-overview'>ElectronJS</Link>

...
Previously we described a <Link href='/posts/final-nodeapi-coding-key-points'>.NET Coding Model</Link> that included some behaviours from this blog’s <Link href='/posts/api-journey-server-side'>API Journey – Server Side</Link> blog post. Next we will provide an equivalent API in Java and Spring.
...
![spa and api](/images/350/spa-and-api.jpg)
...
```markdown
apilocal.authsamples-dev.com login.authsamples-dev.com www.authsamples-dev.com 
```

...
The SPA uses the technically simple [Mustache Template Library](https://github.com/janl/mustache.js/) to bind received data to the SPA's DOM elements. This ensures that potentially dangerous input is escaped, to prevent malicious code execution. This blog's final SPA uses React, which provides similar input protection.

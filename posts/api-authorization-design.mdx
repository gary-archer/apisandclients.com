...
APIs also have an expected audience. This provides a way to group APIs together, to enable access tokens to be shared, or to prevent it. In a small microservices setup, one option is to shared the same audience across APIs:

| API | Audience |
| --- | -------- |
| <span style={{color:'green'}}>**Orders**</span> | api.authsamples.com |
| <span style={{color:'green'}}>**Products**</span> | api.authsamples.com |
| <span style={{color:'green'}}>**Billing**</span> | api.authsamples.com |

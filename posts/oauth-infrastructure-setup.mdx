...
| -------------------- | ----------- |
| https`:`//www.mycompany.com | A base URL for static web content
...
```markdown
127.0.0.1 www.mycompany.com api.mycompany.com login.mycompany.com
```
...
This blog's early SPAs point to Cognito’s issuer base URL and the SPA’s security library then looks up metadata to get the other details it needs:

...
![mobile transactions](/images/240/mobile-transactions.jpg)
...
![mobile companies](/images/240/mobile-companies.jpg)
...
![spa views](/images/240/spa-views.jpg)
...
API requests now use cookie credentials, with the *HTTP-only, Secure, SameSite=strict* properties. Any data changing commands also send a *CSRF token*, in line with OWASP best practices for CSRF prevention:

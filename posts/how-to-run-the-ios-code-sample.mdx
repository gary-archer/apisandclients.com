...
![project layout](/images/550/project-layout.jpg?v=20240713)

Then run the app on a simulator, with your default *Signing and Capabilities* settings, which can be empty if required:

![emulator settings](/images/550/simulator-settings.jpg?v=20240713)
...
| <span style={{color:'green'}}>**Keychain Swift**</span> | Simplifies secure storage of OAuth tokens on devices |
| <span style={{color:'green'}}>**SwiftUI-Tooltip**</span> | A utility to help display a tooltip containing user info |

These references were added via the *Swift Package Manager* and are built as libraries:

![dependencies](/images/550/dependencies.jpg?v=20240713)

I then linked with the built libraries from the following page:

![library linking](/images/550/library-linking.jpg?v=20240713)
...
![running app](/images/550/running-app.jpg?v=20240713)
...
![not found login response](/images/550/not-found-login-response.jpg?v=20240713)
...
![login](/images/550/login.jpg?v=20240713)
...
![landscape](/images/550/landscape.jpg?v=20240713)
...
```bash
xcrun simctl openurl booted https://mobile.authsamples.com/basicmobileapp/deeplink/companies/2
```
...
![access token expiry](/images/550/access-token-expiry.jpg?v=20240713)
...
![refresh token expiry](/images/550/refresh-token-expiry.jpg?v=20240713)
...
![new user login](/images/550/new-user-login.jpg?v=20240713)
...
![error summary](/images/550/error-summary.jpg?v=20240713)
...
![error details](/images/550/error-details.jpg?v=20240713)
...
- Next we will describe some required <Link href='/posts/ios-code-sample-infrastructure'>iOS Mobile Infrastructure</Link>

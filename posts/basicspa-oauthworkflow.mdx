...
This blog recommends an <Link href='/posts/oauth-infrastructure-setup'>OAuth Development Setup</Link> where logical domains similar to the following are used on a development computer. This best enables early thinking about the deployment of each component.
...
Next, the login screen is presented and in a real app the user could authenticate in many possible ways to provide a proof of their identity. In this blog I provide pre-created test users and simple passwords to allow anyone to sign in:

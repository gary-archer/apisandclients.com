...
| Component | Base URL |
| --------- | -------- |
| <span style={{color:'green'}}>**API**</span> | https`:`//apilocal.authsamples-dev.com:446 |
...
```markdown
127.0.0.1 apilocal.authsamples-dev.com login.authsamples-dev.com www.authsamples-dev.com
```

...
Our API has three simple endpoints that exist at the below internet URLs, and the third of these is parameterised via path segments:
...
- Next we will explain our <Link href='/posts/serverless-api-coding-model'>Serverless API Coding Model</Link>  

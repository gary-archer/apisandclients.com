# Serverless API Coding Key Points
...
| <span style={{color:'green'}}>**OAuthAuthorizer**</span> | JWT access token validation, creating the claims principal and identity logging

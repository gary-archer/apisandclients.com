...
![web host certs](/images/170/web-host-certs.jpg)

The *mycompany.ca.pem* file is a root certificate authority that must be added to your system trust store in order for the browser to use SSL without warnings. See the <Link href='/posts/developer-ssl-setup'>Browser SSL Trust</Link> instructions for further information.

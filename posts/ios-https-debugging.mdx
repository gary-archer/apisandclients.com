...
Previously we put in place an initial iOS Setup and ran the <Link href='/posts/ios-setup'>AppAuth iOS Code Sample</Link>. Next I will explain a way to view HTTPS mobile traffic from iOS simulators and devices on a development computer.
...
From an emulator or device you can open Safari and type the IP address of the host. Click a certificate file and save it to the device’s *Downloads* folder:

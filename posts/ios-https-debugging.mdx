...
![ssl trust error](/images/490/ssl-trust-error.jpg?v=20240804)
...
![proxy root ca](/images/490/proxy-root-ca.jpg?v=20240804)

### Deploy the HTTP Proxy Root Certificate

To resolve the trust error you must get the certificate's root certificate authority file to the simulator or device. This can be down in various ways, such as by emailing the file. For the MITM proxy root CA you can just browse to a URL of *http://mitm.it* from the device or simulator.
...
![get proxy root ca](/images/490/get-proxy-root-ca.jpg?v=20240804)
...
![installing cert](/images/490/installing-cert.jpg?v=20240804)
...
![activated cert](/images/490/activated-cert.jpg?v=20240804)

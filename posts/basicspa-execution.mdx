...
To simplify the developer setup, the API also serves the SPA’s bundle files to the browser. A real web host is used later in this blog, when the SPA is deployed to a <Link href="/posts/cdn-static-content-delivery">content delivery network</Link>.

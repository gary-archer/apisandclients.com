...
Most companies want good global performance for their Internet web applications. A *Content Delivery Network (CDN)* is the simplest solution for managing latency. It is harder to enable for web backends that execute code such as cookie issuing, leading to restricted hosting options.

...
```json
{
    "apiBaseUrl": "https://bff.authsamples-dev.com:444/investments",
    "oauthAgentBaseUrl": "https://bff.authsamples-dev.com:444/oauth-agent"
}
```
...
COOKIE_DOMAIN='bff.authsamples-dev.com'

...
Previously we discussed <Link href='/posts/final-desktop-app-coding-key-points'>Coding Key Points</Link> for the final desktop code sample. Next we will get a basic Android OAuth setup working, by running the AppAuth Android code sample.
...
| <span style={{color:'green'}}>**Discovery URI**</span> | `https://cognito-idp.eu-west-2.amazonaws.com/eu-west-2_CuhLeqiE9/.well-known/openid-configuration` |
...
![emulator app](/images/460/emulator-app.jpg)
...
![chrome custom tab](/images/460/chrome-custom-tab.jpg)
...
![logged in](/images/460/logged-in.jpg)

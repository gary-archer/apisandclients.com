...
Previously we discussed <Link href='/posts/final-desktop-app-coding-key-points'>Coding Key Points</Link> for the final desktop code sample. Next we will get a basic Android OAuth Setup working, via the AppAuth Android code sample.

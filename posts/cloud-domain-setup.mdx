...
| <span style={{color:'green'}}>***www*.authsamples.com**</span> | CloudFront URL |
| <span style={{color:'green'}}>**api.authsamples.com**</span> | API Gateway URL for APIs |
| <span style={{color:'green'}}>**bff.authsamples.com**</span> | API Gateway URL for Backend for Frontend |
| <span style={{color:'green'}}>**mobile.authsamples.com**</span> | CloudFront URL |
| <span style={{color:'green'}}>**authsamples.com**</span> | CloudFront URL |

...
| <span style={{color:'green'}}>**`www.authsamples.com`**</span> | CloudFront URL for the SPA's web origin |
...
| <span style={{color:'green'}}>**`authsamples.com`**</span> | CloudFront URL for interstitial pages used by native apps |

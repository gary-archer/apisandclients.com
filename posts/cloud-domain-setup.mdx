...
| Subdomain | Points To | Usage |
| --------- | --------- | ----- |
| <span style={{color:'green'}}>**login.authsamples.com**</span> | Cognito URL | Authorization Server |
| <span style={{color:'green'}}>**www.authsamples.com**</span> | CloudFront URL | Web Content Delivery |
| <span style={{color:'green'}}>**api.authsamples.com**</span> | API Gateway URL | API Hosting |
| <span style={{color:'green'}}>**mobile.authsamples.com**</span> | CloudFront URL | Mobile Logins and Deep Linking |
| <span style={{color:'green'}}>**authsamples.com**</span> | CloudFront URL | Parent Domain |
...
- Next we complete the <Link href='/posts/'>Cloud Authorization Server Setup</Link>
